...
namespace FairyGUIEditor
{
    ...
    public class UIPanelEditor : Editor
    {
        ...
        void OnSceneGUI()
        {
            ...
            var fmh_147_58_637758497753313778 = Quaternion.identity; var fmh_147_115_637759543672063333 = Quaternion.identity; Vector3 newPos = Handles.FreeMoveHandle(pos, sizeFactor, Vector3.one, Handles.ArrowHandleCap);
#else
